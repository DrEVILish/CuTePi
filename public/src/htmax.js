        ...
        #initRequestIndicatorCss() {
            if (this.config.includeIndicatorCSS !== false) {
                ...
                try {
                    ...
                    // No constructable stylesheets (older browsers): a plain
                    // <style> element works everywhere. Must never throw —
                    // this runs in the constructor, and a throw here kills
                    // the htmx global and every script after it.
